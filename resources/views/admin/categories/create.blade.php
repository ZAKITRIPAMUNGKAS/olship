...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:22px;" class="fade-up">
    ...
    <h2 style="font-size:20px;font-weight:700;">Tambah Kategori</h2>
</div>

<form action="{{ route('admin.categories.store') }}" method="POST" class="fade-up delay-1" onsubmit="const btn = this.querySelector('button[type=submit]'); if(btn) setLoading(btn, true, 'Menyimpan...'); return true;">
    @csrf
    <div style="display:grid;grid-template-columns:1fr 340px;gap:20px;">
        <div class="glass-card panel">
            ...
            <div style="margin-bottom:14px;">
                ...
                <input class="form-input" name="name" value="{{ old('name') }}" required placeholder="Nama kategori">
            </div>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:14px;">
                ...
                <div>
                    ...
                    <input class="form-input" name="icon_class" value="{{ old('icon_class') }}" placeholder="fa-box">
                </div>
            </div>
            <div style="margin-bottom:14px;">
            ...
            <div>
                ...
                <input class="form-input" type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0" style="width:120px;">
            </div>
        </div>
